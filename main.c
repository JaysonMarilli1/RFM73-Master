...
void sub_program_1hz(char status);
...
/// Jayson Testing
const UINT8 tx_buf_CALL[17] = {0x30, 0x31, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0xe5};
const UINT8 tx_buf_CANCEL[17] = {0x30, 0x30, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0x2e, 0xe4};
/// Jayson Testing
...
void main(void) {
    ...
    while (1) {
        ...
        if (BUTTON_CALL == 0 && call_FLAG == '1') {
            sub_program_1hz(send_CALL);
            call_FLAG = '0';
            cancel_FLAG = '1';
        }
        if (BUTTON_CANCEL == 0 && cancel_FLAG == '1') {
...
void sub_program_1hz(char status) {
    ...
    if (Flag.reach_1s) {
        ...
        if (status == '1') {
            for (i = 0; i < 17; i++) {
                //temp_buf[i] = tx_buf[i];
                temp_buf[i] = tx_buf_CALL[i];
            }
        }
        if (status == '0') {
            for (i = 0; i < 17; i++) {
                //temp_buf[i] = tx_buf[i];
                temp_buf[i] = tx_buf_CANCEL[i];
            }
        }
//        for (i = 0; i < 17; i++) {
//            //temp_buf[i] = tx_buf[i];
